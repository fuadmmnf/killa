                ...
                <div class="col-md-8 col-sm-8">
                    ...
                    <div class="blog-listing blog-listing-classic no-margin-top wow fadeIn">
                        ...
                        <div class="blog-details">
                            <div class="blog-date">Posted by <a href="{{ route('blogger.profile', $blog->user->unique_key) }}"><b>{{ $blog->user->name }}</b></a> | {{ date('F d, Y', strtotime($blog->created_at)) }} | <a href="{{ route('blog.categorywise', $blog->blogcategory->name) }}">{{ $blog->blogcategory->name }}</a> </div>
